    ...
    >
      <div className="max-w-[1120px] mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 sm:gap-8">
          ...
          <Link
            href="/login"
            className="text-sm text-[#9a9f9c] hover:text-[#5DCAA5] transition-colors"
          >
            Entrar
          </Link>
          <Link
            href="#cta"
            className="inline-flex items-center gap-2 px-3 sm:px-6 py-2 rounded-lg text-xs sm:text-sm font-medium bg-[#1D9E75] text-white transition-all duration-200 hover:bg-[#3DB88E] hover:-translate-y-px hover:shadow-[0_8px_32px_rgba(29,158,117,0.3)]"
          >
            <span className="hidden xs:inline">Analisar grátis</span>
            <span className="xs:hidden font-semibold">Analisar</span>
          </Link>
        </div>
      </div>
    </nav>
